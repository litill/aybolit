              ...
              <div class="gv-list-view" id="gv_list_6">
                  ...
                  <div class="gv-list-view-content-description">
                    <div class="cxl-job-description gv-field-1-11" id="gv-field-1-11">
                      ...
                      <p>
                        ...
                        invested. We’re on a mission to enable everyone to take part in the world’s
                        success by making investing simple, affordable and accessible.
                      </p>
                      <p>
                        Change is quickly emerging as one of the leading investment apps in Europe.
                        Cryptocurrencies will soon be accompanied by stocks and cash management
                        putting us in a position to change the financial future of millions of
                        people around the world.
                      </p>
                      <p>
                        For the past 2 years we have been focused on building the core value for our
                        users, creating an outstanding product and killer team. Exponential organic
                        growth - we’re doubling our core KPI-s monthly - shows we have succeeded and
                        now it’s time to take out the big guns. We are looking for you to
                        aggressively scale. You will be responsible for all digital marketing
                        activities across 28 European countries.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        he best in digital marketing, so you tell us what kind of a team you need to
                        build. We believe in autonomous cross-functional teams as a hint for what
                      ...
                      <ul>
                        <li>
                          You will be responsible for developing and executing the digital strategy
                          across all areas including but not limited top paid advertising (mainly
                          Twitter, Google, FB), social media, content, email, affiliate, referral,
                          SEO and ASO;
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          cost per lead and cost per depositor results while maintaining exponential
                          WoW growth;
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          Success in delivering hyper growth at a B2C tech company, at least 20% MoM
                          over a one year period, with industry leading acquisition cost;
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          internal and external resources for tech, design, creative, copy, content
                          and more;
                        </li>
                        <li>
                        ...
                        <li>
                          Experience working across functions and managing diverse stakeholders. You
                          can speak anyone’s language from engineers to legal and supervisory board;
                        </li>
                        <li>
                      ...
                      <ul>
                        <li>Stock package, competitive salary, health insurance, pension fund;</li>
                ...
                <div class="gv-grid gv-list-view-footer">
                  <div class="gv-grid-col-1-2 gv-left">
                    <div class="cxl-job-edit-entry gv-field-1-edit_link" id="gv-field-1-edit_link">
